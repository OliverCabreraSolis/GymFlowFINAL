    ...
    <main class="main-content">
        ...
        <section class="crud-menu">
            <div class="crud-options">
                ...
                <!-- Tipos de Producto -->
                <a href="${pageContext.request.contextPath}/tipoproducto/list" class="crud-card">
                    <i class="fas fa-boxes"></i>
                    <h3>CRUD Tipos de Producto</h3>
                </a>

                <!-- Productos -->
                <a href="${pageContext.request.contextPath}/producto/list" class="crud-card">
                    <i class="fas fa-box"></i>
                    <h3>CRUD Productos</h3>
                </a>

                <!-- Usuarios -->
                <a href="${pageContext.request.contextPath}/usuario/list" class="crud-card">
